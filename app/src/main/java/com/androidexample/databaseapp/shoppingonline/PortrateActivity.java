...
import com.androidexample.databaseapp.shoppingonline.data.FrameToRecord;
import com.androidexample.databaseapp.shoppingonline.data.RecordFragment;
import com.androidexample.databaseapp.shoppingonline.util.CameraHelper;
import com.androidexample.databaseapp.shoppingonline.util.MiscUtils;
...
//        cameraHeight = 720;
//    }
    public class PortrateActivity  extends AppCompatActivity implements
        TextureView.SurfaceTextureListener, View.OnClickListener {

        private static final String LOG_TAG = PortrateActivity.class.getSimpleName();

        private static final int REQUEST_PERMISSIONS = 1;

        private static final int PREFERRED_PREVIEW_WIDTH = 2480;
    private static final int PREFERRED_PREVIEW_HEIGHT = 1440;

        // both in milliseconds
        private static final long MIN_VIDEO_LENGTH = 1 * 1000;
        private static final long MAX_VIDEO_LENGTH = 15 * 1000;
    ...
    That is, the preview size is the size before it is rotated. */
        ...
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.activity_portrate);
            mPreview = findViewById(R.id.wrap_view);
            DisplayMetrics metrics = new DisplayMetrics();
            getWindowManager().getDefaultDisplay().getMetrics(metrics);
            videoWidth = metrics.widthPixels;
            videoHeight = metrics.heightPixels;
//            Toast.makeText(this, "height:"+metrics.heightPixels, Toast.LENGTH_SHORT).show();
        ...
        public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
            ...
            if (requestCode == REQUEST_PERMISSIONS) {
                ...
                if (permissionsAllGranted) {
                    doAfterAllPermissionsGranted = () -> doAfterAllPermissionsGranted();
                } else {
                    doAfterAllPermissionsGranted = () -> {
                        Toast.makeText(PortrateActivity.this, R.string.permissions_denied_exit, Toast.LENGTH_SHORT).show();
                        finish();
                    };
                }
            }
...
//        parameters.setPreviewFormat(ImageFormat.NV21);
        ...
        private void stopRecorder() {
            ...
            runOnUiThread(() -> mBtnReset.setVisibility(View.INVISIBLE));
        }
...
//                    Frame filteredFrame = recordedFrame.getFrame();
        ...
        abstract class ProgressDialogTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                mProgressDialog = ProgressDialog.show(PortrateActivity.this,
...
//            mProgressDialog.setProgress(values[0]);
        ...
        class FinishRecordingTask extends ProgressDialogTask<Void, Integer, Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Intent intent = new Intent(PortrateActivity.this, PlaybackActivity.class);
